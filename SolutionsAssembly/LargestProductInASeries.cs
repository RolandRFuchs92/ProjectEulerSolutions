...
namespace SolutionsAssembly
{
	...
	{
		private string _thousandDigitNumber =>
Regex.Replace(@"73167176531330624919225119674426574742355349194934
...
71636269561882670428252483600823257530420752963450", @"\s+", string.Empty);
